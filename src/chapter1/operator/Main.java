...
public class Main { // 1-6 연산자
    ...
    public static void main(String[] args) {
        ...
        System.out.println(":::" + (age >= 18 && isStudent));   //true && true

        //OR 연산자(||) - 두 조건중 하나라도 참이라면 true 반환합니다.
        ...
        //연산자 우선순위
        boolean flag = 10 + 5 > 12 && true; // ((10 + 5) > 12) && ture
        ...
        //논리 연산자 우선순위 (! -> && -> ||)
        boolean result = true || false && false;    //ture || (false && false)
        // 실행 순서 : ! 없어서 && 연산 실행
        // false && false -> false
        // true || false -> true
        // result = true
